...
- **Deploying to the cloud?** Use `authenticated` + `public` — see the budget single-VM guides for [Azure](azure-vm.md) (~$36-44/mo) and [AWS EC2](aws-ec2.md) (~$33/mo), or the [AWS ECS Fargate guide](aws-ecs.md) (~$110/mo, managed)
